...
def lancer_partie(game_mode, difficulte):
    ...
    return render_template('lancer_partie.html', game_mode=game_mode, difficulte=difficulte, mot_choisi=mot_choisi, liste_affichage=liste_affichage, liste_lettres_devinees=liste_lettres_devinees, vies=vies, currentIndex=currentIndex, lien_image=lien_image)
