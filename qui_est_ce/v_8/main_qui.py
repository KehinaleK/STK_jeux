...
def game_start(themes):
    ...
    return render_template('affichage_images.html', dico=dico_images, attribute=first_attribute, eliminable_images=eliminable_images, images_eliminees=images_eliminees, themes=themes)
...
def next_attribute(themes):
    ...
    if 'current_index' in session:
        ...
        if current_index != longueur:
            ...
            session['images_eliminees'] = images_eliminees
            return jsonify(attribute=next_attribute, eliminable_images=eliminable_images, images_eliminees=images_eliminees, themes=themes)
